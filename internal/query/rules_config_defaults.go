...
func defaultRuleConfig() RuleConfig {
	cfg := RuleConfig{
		...
		ContractSourceTableLexicon: map[string][]string{
			"default": {"tenant_uhub.fin_contracts", "tenant_uhub.fin_fund_income", "tenant_uhub.fin_fund_income_groups", "tenant_uhub.fin_fund_income_group_members"},
			"aggregate_summary": {
			...
			"supplier_contract": {
				...
				"tenant_uhub.fin_cost_settlement_groups",
				"tenant_uhub.fin_cost_settlement_group_members",
				"tenant_uhub.fin_bank_statement",
			},
			"mixed_contract": {
				"tenant_uhub.fin_contracts",
				"tenant_uhub.fin_fund_income",
		...
		IntentKeywordLexicon: map[string][]string{
			...
			string(IntentLargeTransactionQuery): {"最大", "单笔", "大额", "流入对手方", "流出对手方"},
		...
		ExpenseBreakdownTriggerKeywordLexicon:     []string{"拆", "拆分", "拆开", "掰开", "大类", "构成", "分类", "类别", "结构", "花哪", "花到哪", "花在哪"},
		ExpenseBreakdownExpenseKeywordLexicon:     []string{"整体支出", "总支出", "全部支出", "支出", "费用", "开支", "花销", "花费", "钱花", "花了", "花哪", "付款", "支付"},
