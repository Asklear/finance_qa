...
func (e *Engine) collectContractDimensionSummary(question, entity string, anchor time.Time) (contractDimensionSummary, error) {
	...
	summary := newContractDimensionSummary(entity, role, from, to, askedTopic, contracts)
	if askedTopic == "content" {
		summary.Role = "contract_content"
		summary.Data["role"] = "contract_content"
		summary.Data["source_tables"] = contractSourceTablesForRole("contract_content")
...
func newContractDimensionSummary(entity, role, from, to, askedTopic string, contracts []contractDimensionRow) contractDimensionSummary {
	...
	return contractDimensionSummary{
		...
		Data: map[string]any{
			...
			"source_tables":  contractSourceTablesForRole(role),
		},
		ExecutedSQL: []string{
