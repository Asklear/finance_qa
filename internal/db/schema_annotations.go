...
var commonColumnComments = map[string]string{
	...
	"contract_id":                "合同编号",
	"customer_name":              "客户名称",
	"customer_tax_id":            "客户/供应商纳税人识别号",
	"contract_content":           "合同/项目内容",
	"po_number":                  "采购订单号或 PO 编号",
	"buyer_contract_number":      "采购方合同编号",
	"project_code":               "项目编码",
	"contract_start_date":        "合同开始日期",
	"contract_end_date":          "合同终止日期",
	"settlement_cycle":           "结算周期",
	"settlement_period_start":    "结算期间开始日期",
	"settlement_period_end":      "结算期间结束日期",
	"settlement_unit_price":      "结算单价",
	"quantity_detail":            "结算数量或工作量明细",
	"calculation_formula":        "结算金额或数量计算公式",
	"price_unit":                 "价格单位",
	"service_scope_summary":      "服务范围摘要",
	"applicant_contact_info":     "申请人或业务联系人信息",
	"created_at":                 "创建时间",
	...
	"is_invoiced":                "是否已开票",
	"invoice_amount":             "开票金额",
	"invoice_open_offset_amount": "用于抵扣已开票未回款/已收票未付款的备注调整金额",
	"invoice_open_offset_reason": "备注调整金额的来源说明",
	"remarks":                    "来源表可见备注列内容",
	"paid_amount":                "实际付款金额",
	...
	"source_email_message_id":    "导入来源邮件的 message-id，用于追溯邮件附件来源",
...
var schemaAnnotations = map[string]SchemaTableAnnotation{
	...
	"contract_main": buildSchemaTableAnnotation(
		...
		map[string]string{
			...
			"buyer_tax_id":        "合同 OCR 识别出的购买方纳税人识别号",
			"seller_tax_id":       "合同 OCR 识别出的销售方纳税人识别号",
			"sign_date":           "合同签署日期",
			"start_date":          "合同开始日期",
			"end_date":            "合同终止日期",
