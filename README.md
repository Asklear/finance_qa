...
- finance_qa / Go MCP: `~/finance_qa/bin/financeqa version`（当前 `2.0.11`）
- OpenClaw Plugin: `~/.openclaw/extensions/openclaw-finance/package.json`（当前 `2.0.11`，且 `openclaw.extensions` 必须包含 `./dist/index.esm.js` 才能被 OpenClaw 发现）
